import { useState, useEffect } from "react"//useEffect va a ejecutarse cuando el componente cargue
import { useParams, Link } from "react-router-dom";//para obtener, leer el token de la url
  ...
  useEffect(() => {
    const comprobarToken = async () => {
      try {
        ...
        //si se modifica correctamente lo pasamos a true
        setTokenValido(true)
      } catch (error) {
        setAlerta({
